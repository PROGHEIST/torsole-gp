...
from .views import GramPanchayatInfoViewSet, SlideShowViewSet, AboutVillageViewset, MissionViewSet, MissionObjectivesViewSet, ImportantLinksViewset, GovernmentGRViewset, DepartmentViewset
